...
{
	ulong Temp;
	Temp = (ulong)Amp * 22.38251366; //将输入幅度因子分为两个字节  25.20615385=(2^14)/650 2^14/732=22.38251366
	/*
	Freq(Hz)	1		10		100		1K		10K		100K	1M		10M	40M
	Vppmax(mV)	456		724		740		730		732		736		732		708	556
	*/
	if (Temp > 0x3fff)
		Temp = 0x3fff;
	Temp &= 0x3fff;
...
{
	ulong Temp1, Temp2, ITemp3, ITemp4, DTemp4;
...
//	DTemp3 = ITemp3;
	...
	drgparameter[11]=0x0F;
	drgparameter[10]=0xFF;
	drgparameter[9]=0xFF;
	drgparameter[8]=0x00;
	//步进时间间隔（单位：us）
