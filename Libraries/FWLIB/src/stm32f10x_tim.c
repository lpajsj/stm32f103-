...
/**
  ...
  *     @arg TIM_CounterMode_CenterAligned1: TIM Center Aligned Mode1  下降置一
  *     @arg TIM_CounterMode_CenterAligned2: TIM Center Aligned Mode2  上升置一
  *     @arg TIM_CounterMode_CenterAligned3: TIM Center Aligned Mode3  上升下降都置一
  * @retval None
  */
...
/**
  ...
  *     @arg TIM_TS_ITR3: Internal Trigger 3 //看手册从模式寄存器
  *     @arg TIM_TS_TI1F_ED: TI1 Edge Detector  //TI边沿寄存器
  *     @arg TIM_TS_TI1FP1: Filtered Timer Input 1
  *     @arg TIM_TS_TI2FP2: Filtered Timer Input 2
  *     @arg TIM_TS_ETRF: External Trigger input  //外部触发
  * @retval None
  */
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg TIM_ICPolarity_Falling: IC Falling edge.
  *     @arg TIM_ICPolarity_Rising: IC Rising edge.  同下异上
  * @retval None
  */
...
/**
  ...
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None使能捕获的dma请求，否则发生更新事件才会有请求
  */
...
/**
  ...
  *     @arg TIM_UpdateSource_Regular: Source of update is the counter overflow/underflow
                                       ...
                                       through the slave mode controller可能是复位模式.
...
/**
  ...
  *                              is to be set, as soon as a capture or compare match occurs (TRGO).捕获/比较 1 
...
/**
触发输入(TRGI)上的事件被延迟了，以允许在当前定时器(通过TRGO)与它的从定时器间的
